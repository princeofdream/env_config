...
if [[ ${USE_EXTERN_TOOLCHAIN_ENV}"" == "true" ]]; then
	...
	append_path_priority_env "$PATH_TOOLCHAIN_GCC_BASE/arm-none-eabi/bin"
	append_path_priority_env "$PATH_TOOLCHAIN_GCC_BASE/aarch64-none-elf/bin"
	append_path_priority_env "$PATH_TOOLCHAIN_GCC_BASE/arm-none-linux-gnueabihf/bin"
	append_path_priority_env "$PATH_TOOLCHAIN_GCC_BASE/aarch64-none-linux-gnu/bin"
...
alias vv='env DISPLAY="" nvim -p'
alias nn='env DISPLAY="" vim -p'
